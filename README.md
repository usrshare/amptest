...
The program's source code also borrows the input and output plugin structures from the official Winamp SDK (as available [here])http://wiki.winamp.com/wiki/SDK\_Contents)) in what I _really_ hope constitutes fair use.
